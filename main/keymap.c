...
uint16_t _C87[MATRIX_ROWS][KEYMAP_COLS] = {

	/* Plugins
				 * ,---------------------------------------------------------.
				 * | Esc  |  F1  |  F2  |  F3   |      |      | Prtsc |  Scr |
				 * |------+------+------+-------+------+------+-------+------|
				 * |   ~  |   1  |  Tab |   Q   | Caps |   A  | ShiftL|   Z  |
				 * |------+------+------+-------+------+------+-------+------|
				 * |   2  |   3  |   W  |   E   |   S  |   D  |    X  |   C  |
				 * |------+------+------+-------+------+------+-------+------|
				 * |   4  |   5  |   R  |   T   |   F  |   G  |    V  |   B  |
				 ...
				 * |   +  | Back |   ]  |   \   | Enter|      | CtrlR |      |
				 * |------+------+------+-------+------+------+-------+------|
				 * |Insert| Home |  Del |  End  |  Fn  |  Up  | Bottom| Left |
				 * |------+------+------+-------+------+------+-------+------|
				 * |PageUp|      |PageDn|  F10  |  F11 |  F12 |  Right |      |
				 * |------+------+------+-------+------+------+-------+------|
				 * |  F4  |  F5  |  F6  | Pause |      |      |       |      |
				 * |------+------+------+-------+------+------+-------+------|
				 * |  F7  |  F8  |  F9  |       |      |      |       |      |
				 * |------+------+------+-------+------+------+-------+------|
				 * |      |      | WinL | CtrlL | AltL | Space|  WinR | AltR |
				 * `------------------------------------------'    ----------'
				 */
	{KC_ESC, KC_F1, KC_F2, KC_F3, KC_NONE, KC_NONE, KC_PSCREEN, KC_SCROLLLOCK},
	{KC_GRV, KC_1, KC_TAB, KC_Q, KC_CAPS, KC_A, KC_LSHIFT, KC_Z},
	{KC_2, KC_3, KC_W, KC_E, KC_S, KC_D, KC_X, KC_C},
	{KC_4, KC_5, KC_R, KC_T, KC_F, KC_G, KC_V, KC_B},
	{KC_6, KC_7, KC_Y, KC_U, KC_H, KC_J, KC_N, KC_M},
	{KC_8, KC_9, KC_I, KC_O, KC_K, KC_L, KC_COMM, KC_DOT},
	{KC_0, KC_MINUS, KC_P, KC_LBRC, KC_SCLN, KC_QUOT, KC_SLSH, KC_RSHIFT},
	{KC_EQUAL, KC_BSPACE, KC_RBRC, KC_BSLASH, KC_ENTER, KC_NONE, KC_RCTRL, KC_NONE},
	{KC_INSERT, KC_HOME, KC_DEL, KC_END, KC_FN0, KC_UP, KC_DOWN, KC_LEFT},
	{KC_PGUP, KC_NONE, KC_PGDOWN, KC_F10, KC_F11, KC_F12, KC_RIGHT, KC_NONE},
	{KC_F4, KC_F5, KC_F6, KC_PAUSE, KC_NONE, KC_NONE, KC_NONE, KC_NONE},
	{KC_F7, KC_F8, KC_F9, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE},
	{KC_NONE, KC_NONE, KC_LWIN, KC_LCTRL, KC_LALT, KC_SPACE, KC_RWIN, KC_RALT}

};
//Create an array that points to the various keymaps
uint16_t (*default_layouts[])[MATRIX_ROWS][KEYMAP_COLS] = {&_C87};
