...
const gpio_num_t MATRIX_ROWS_PINS[] = { GPIO_NUM_13, GPIO_NUM_12, GPIO_NUM_14,
		...
		GPIO_NUM_33, GPIO_NUM_32, GPIO_NUM_21, 
		GPIO_NUM_3, GPIO_NUM_1, GPIO_NUM_22, 
		GPIO_NUM_23, };
const gpio_num_t MATRIX_COLS_PINS[] = { GPIO_NUM_15, GPIO_NUM_2, GPIO_NUM_4,
		GPIO_NUM_16, GPIO_NUM_17, GPIO_NUM_5,GPIO_NUM_18,GPIO_NUM_19 };
